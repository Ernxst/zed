...
impl ImeMirror {
    pub(crate) fn new(
        ...
        // Host input/textarea styles must not reveal or reposition GPUI's IME conduit.
        element
        ...
        style
            .set_property_with_priority("font-size", "16px", "important")
            .ok();
    ...
    /// Park the hidden field on the focused caret. iOS may dismiss the
    /// keyboard when the focused control remains a clipped 1px box at (0,0).
